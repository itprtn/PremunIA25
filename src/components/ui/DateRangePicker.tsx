...
export function DateRangePicker({ date, onSelect, className }: DateRangePickerProps) {
  return <DatePickerWithRange date={date} onSelect={onSelect} className={className} />
}

export function DatePickerWithRange({ date, onSelect, className }: DateRangePickerProps) {
  return (
